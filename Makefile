.PHONY: all launcher clean sdl2 lua freetype mono
...
launcher: all
	...
	@mv build/OpenRA OpenRA.app/Contents/MacOS
	@echo "APPL????" > OpenRA.app/Contents/PkgInfo
	@cp Info.plist OpenRA.app/Contents
	@cp dependencies/Eluant.dll.config OpenRA.app/Contents/Resources
	@cp dependencies/liblua.5.1.dylib OpenRA.app/Contents/Resources
	@cp dependencies/libSDL2.dylib OpenRA.app/Contents/Resources
	@cp dependencies/libfreetype.6.dylib OpenRA.app/Contents/Resources
	@cp dependencies/mono OpenRA.app/Contents/MacOS
	@cp -r dependencies/etc OpenRA.app/Contents/MacOS
	@cp -r dependencies/lib OpenRA.app/Contents/MacOS
